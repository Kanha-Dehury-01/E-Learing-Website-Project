    ...
    <section class="w-100 p-4 d-flex justify-content-center pb-4">
        <div style="width: 26rem;">
          ...
          <ul class="nav justify-content-center">
            <li class="nav-item">
              <button class="tablinks shadow-sm btn bg-danger text-white rounded-4 pill btn-lg m-2 border-2" ><strong>Add Student</strong></button>
            </li>
          </ul>
          <!-- Pills navs -->
          ...
          <div class="tab-pane active tabcontent show" id="pills-register">
              <form action="student_admin_res.php" method="post" enctype="multipart/form-data">
                ...
                <!-- Submit button -->
                <button type="submit" name="saves" class="btn btn-danger btn-block mt-5">Add Student</button>
              </form>
            </div>
