...
<body>
    ...
    <img src="Image/ContactUs.png" alt="" style="width:100%;">
    <br><br>

    <div style="width:80%; margin:0 auto; " class=" d-flex ">
        <div class="text-center" style="margin:0 auto; ">

            <h1><strong>Connecting people with knowledge</strong></h1><br><br><br>
            <p>Whether you want to learn or to share what you know, you’ve come to the right place. As a global
                destination for <br> online learning, we connect people through knowledge.</p>
    ...
    <div style="width:60%; margin:0 auto; font-size:1.2em; margin-bottom:10%; margin-top:10%;">

        <p class="text-left">Thank you for your interest in our educational website. We are committed to providing high-quality educational resources and are always happy to hear from our users. Please find below our contact information and how to reach us:</p>
        <br>
        <br>

        <h2>Contact Information:</h2>
        <p>
            Address : Chandrasekharpur, Bhubaneswar, Odisha ,751024 <br>
            Phone : +91 9668505568 <br>
            Email : kanhadehury2001@gmail.com <br>
        ...
        <p>
        We take your privacy seriously. Please review our  <a href="TermsAndCondition.php">Privacy Policy</a> to understand how we collect, use, and protect your personal information.
        </p>
        ...
        <p>
        We invite you to follow us on social media to stay up-to-date with our latest news, updates, and educational resources. Please find our social media links below:
        </p>

        <br><br>

        <p>
        We value your feedback and are always looking for ways to improve our website. Thank you for your support and we look forward to hearing from you!
        </p>
